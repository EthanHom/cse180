...
public:
    ...
    : Node("trackdifferences")
    {
        ...
        // Create timer to compute and print differences (infinite loop)
        timer_ = this->create_wall_timer(
        std::chrono::milliseconds(500), std::bind(&TrackDifferences::timer_callback, this));
...
private:
    ...
    double quaternion_to_yaw(const geometry_msgs::msg::Quaternion& quat)
    {
        ...
        // Use tf2::getYaw to extract yaw from quaternion
    ...
    void timer_callback()
    {
        ...
        try {
        // Get transform from odom to map frame
        geometry_msgs::msg::TransformStamped transform_stamped;
        transform_stamped = tf_buffer_->lookupTransform("map", "odom", tf2::TimePointZero);

        // Transform odom pose to map frame for coordinate transformation
        ...
        // Calculate differences in x, y, and yaw
        ...
        // Extract yaw from quaternions using class utilities
