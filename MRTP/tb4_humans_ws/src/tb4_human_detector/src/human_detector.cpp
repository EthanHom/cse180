...
// =============================================================================================
// MRTP FINAL PROJECT: ROBUST HUMAN DETECTOR v5 (Corner & Edge Fix)
// 
// Updates:
// 1. Expanded Bounds: Now accepts detections up to +/- 14.9m X and +/- 24.9m Y.
//    (Fixes failure to detect human at 14, -24).
// 2. Increased Laser Range: Uses readings up to 6.0m to see deep into corners.
// 3. Tighter Coverage: Reduced step size to 3.5m for better edge visibility.
// 4. Tuned Wall Buffer: Keeps the ~30cm buffer to ignore walls while detecting humans.
// =============================================================================================



// =============================================================================================
// MRTP FINAL PROJECT: ROBUST HUMAN DETECTOR v7 (Wall & Pole Fix)
// 
// Updates:
// 1. Bounds Tightened: X [+/- 14.6], Y [+/- 24.6]. Rejects wall ghosts at 24.7+.
// 2. Wall Buffer Increased: 16 cells (~48cm). Prevents detecting map poles/barriers as humans
//    even under significant AMCL drift.
// =============================================================================================
